...
#include "simscape_model_9755456e_1_ds_dxy_p.h"
...
int32_T simscape_model_9755456e_1_ds_dxy_p ( const NeDynamicSystem * sys ,
...
5 , 0 , 1 , 3 , 4 , 2 , 4 } ; ( void ) t1 ; out -> mDXY_P . mNumCol = 14UL ;
out -> mDXY_P . mNumRow = 6UL ; out -> mDXY_P . mJc [ 0 ] = _cg_const_1 [ 0 ]
...
mDXY_P . mIr [ 13 ] = _cg_const_2 [ 13 ] ; ( void ) sys ; ( void ) out ;
return 0 ; }
